...
Usage:
    ...
    API_URL=https://neon-margin-trade.preview.emergentagent.com/api python scripts/e2e_test.py
...
BASE_URL = os.environ.get('API_URL', 'https://neon-margin-trade.preview.emergentagent.com/api')
